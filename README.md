...
| Transformation | dbt materialises reporting models in `mart`, keeps observed plan and agreement versions, and derives a status-change fact from consecutive snapshots |
