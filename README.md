...
| Transformation | dbt materialises reporting models in `mart`, keeps observed plan and agreement versions, and separates status changes from source removals |
